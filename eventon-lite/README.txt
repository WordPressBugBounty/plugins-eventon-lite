...
== Changelog ==
= 2.5.9 (2026-9-19) = 
FIXED: bottom nav showing html code
FIXED: location not able to save new selection
...
UPDATED: Custom repeats UI

= 2.5.2 (2026-4-6) = 
FIXED: undefined IMG error on event pages
...
FIXED: Edit event page console error on block
FIXED: Calendar not loading for non loggedin users
FIXED: custom repeat not saving
...
FIXED: live now events breaking the view
FIXED: backend button styles
UPDATED: eventtop layout design 
UPDATED: how the evo_helper() is called 
